...
const suggestionsRouter = require('./routes/suggestions.route');
const touristicStatusesRouter = require('./routes/touristic-statuses.route');
...
app.use(function(req, res, next) {
  res.header('Access-Control-Allow-Origin', 'http://localhost:4200'); // https://sample-be.herokuapp.com
  res.header(
...
app.use('/touristic-statuses', touristicStatusesRouter); 
